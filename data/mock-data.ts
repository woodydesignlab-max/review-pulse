...
export const mockAnalysisData: AnalysisReport = {
  analyzedAt: "2024-03-19T09:30:00Z",
  app: {
    name: "카카오뱅크",
  ...
  summary: {
    avgRating: 4.2,         // Google Play 공식 전체 평균 (가중 평균)
    sampleAvgRating: 3.4,   // 수집 샘플 200건 평균 (최신 편향)
    sampleCount: 200,        // 실제 수집된 리뷰 수
    totalReviews: 48320,
    recentReviews: 1240,
    negativeRatio: 18,
    positiveRatio: 67,
  ...
  recentNegativeIssues: [
    {
      title: "로그인 오류 급증",
      description: "최근 30일 동안 '로그인이 안 된다', '인증 오류' 관련 불만이 42% 증가했습니다.",
      count: 156,
      trend: "up",
    },
    {
      title: "앱 속도 저하",
      description: "최근 업데이트 이후 로딩 속도가 느리다는 언급이 증가하고 있습니다.",
      count: 98,
      trend: "up",
    },
    {
      title: "알림 미수신",
      description: "이체 및 결제 알림이 오지 않는다는 신고가 반복되고 있습니다.",
      count: 67,
      trend: "stable",
    },
  ],
  insights: {
    summary:
      "최근 사용자들은 로그인 오류와 느린 로딩에 가장 큰 불만을 보이고 있습니다. 반면 UI 가독성과 송금 편의성은 지속적으로 긍정 평가를 받고 있습니다.",
    ...
    positive: [
      {
        ...
        rating: 5,
        date: "2024-03-18",
        text: "송금이 너무 편해요. 공인인증서 없이 이렇게 빠르게 되는 게 신기해요. UI도 깔끔하고 직관적입니다.",
      },
      {
        author: "park***",
        rating: 5,
        date: "2024-03-17",
        text: "다른 은행 앱 쓰다가 넘어왔는데 진짜 쓰기 편해요. 금리도 좋고 이자 자동으로 붙는 것도 좋습니다.",
      },
      {
        author: "jung***",
        rating: 4,
        date: "2024-03-16",
        text: "전통 은행 앱보다 훨씬 빠르고 UX도 잘 되어 있어요. 통장 개설도 10분이면 되고, 카드 발급도 간편해서 자주 씁니다.",
      },
    ],
    negative: [
      {
        ...
        rating: 1,
        date: "2024-03-19",
        text: "로그인이 갑자기 안 돼요. 비밀번호 맞게 입력했는데 계속 오류 납니다. 급하게 송금해야 하는데 너무 불편해요.",
      },
      {
        author: "choi***",
        rating: 2,
        date: "2024-03-18",
        text: "업데이트 이후로 앱이 너무 느려졌어요. 메인 화면 뜨는 데만 10초가 걸립니다. 개선 부탁드려요.",
      },
      {
        author: "yoon***",
        rating: 2,
        date: "2024-03-17",
        text: "이체 알림이 한 시간 늦게 오거나 아예 안 올 때가 많아요. 금융 앱에서 알림은 정말 중요한데 자꾸 이러면 신뢰가 떨어집니다.",
      },
    ],
  },
};

export async function getMockAnalysis(): Promise<AnalysisReport> {
